...
/**
 * @brief Parses parmaeters in function calls.
 * @param error_code Pointer to an integer to store error codes.
 * @return Pointer to the ASTNode representing the parameters.
 */
...
/**
 * @brief Parses a list of parameters in function declarations.
 * @param error_code Pointer to an integer to store error codes.
 * @return Pointer to the ASTNode representing the parameter list.
 */
